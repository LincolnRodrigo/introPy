...
def brincar_de_para_ou_continua():
    ...
    while resposta.upper() == 'C':
        resposta = input('Digite C para continuar ou qualaquer outro caracter parar')
...
if __name__ == '__main__':
    ...
    # chamar a função de cálculo da area do retângulo
